 ...
 */
package gov.sandia.canaryeds.base.workflows;

import gov.sandia.canaryeds.base.EventStatus;
import gov.sandia.canaryeds.base.Workflow;
...
/**
 * @if doxyUser
 * @page userV4External Configuration Details: Using workflows.V4External
 * 
 * @endif
 */
/**
 * Provides CANARY-EDS v4.3 external type algorithms.
 * Please see the \ref userConfigV4External page for configuration details.
 * @todo Not available in BETA release.
 *
 * @internal
 * @author dbhart
 */
public class V4External extends DescribableImpl implements Workflow {
